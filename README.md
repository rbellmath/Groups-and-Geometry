...
This README was generated by running `pretext new course`.  This README retains important notes from the pretext new course template.
The only update is the mention of alternative ways to build and view the course.
...
You can type CMD + Shift + P to activate a bar at the top.  Select PreTeXt: build, etc. to achieve the same as the terminal commands.
